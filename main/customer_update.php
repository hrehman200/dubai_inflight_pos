...
<form id="profile-form" action="api.php" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <input type="text" name="customer_name" id="customer_name" class="form-control"
               placeholder="Customer Name" value="<?=$row['customer_name']?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="text" name="dob" id="dob" class="form-control" placeholder="Date of Birth" value="<?=$row['dob']?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="customer_img" style="display: inline; line-height: 20px; vertical-align: top;" >Image:</label>
        <?php
        if($row['image'] != '') {
