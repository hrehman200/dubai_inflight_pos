...
<button  style="float:right;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Print</button></a> <br><br>  
<button  style="float:right;" class="btn btn-success btn-mini" onclick="convertToCSV()" id= "exportCSV" /><i class="icon-plus-sign icon-large"></i> Export </button>
<br><br>


</div>
<form action="salesreport.php" method="get">
<center><strong>From : <input type="text" style="width: 223px; padding:3px;height: 30px;" name="d1" class="tcal" value="" /> To: <input type="text" style="width: 223px; padding:3px;height: 30px;" name="d2" class="tcal" value="" />
