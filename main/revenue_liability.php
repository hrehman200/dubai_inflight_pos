        ...
        <div class="span10">
            ...
            <div>
                ...
                <form id="formRnL" action="revenue_liability.php" method="get">
                    ...
                    <button style="width: 123px; height:35px; margin-top:-2px; float:right;" class="btn btn-info btn-large" onclick="convertToCSV()"><i class="icon icon-columns icon-large"></i> Export</button>
                ...
                <div class="content" id="content">
                    ...
                    <table class="table table-striped" id="tblRnLSummary">
                        ...
                        $arr_paid = json_encode(array_map(function ($v) {
                            return round($v['aed_value'], 1);
                        }, $arr_revenue));
                        ?>
                        <tr>
                            <td><b>Total:</b></td>
