    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            ...
            <input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter"
                   placeholder="Search Partner..." autocomplete="off"/>
            <a rel="facebox" href="addpartner.php">
                ...
                for ($i = 0; $row = $result->fetch(); $i++) {
                    ...
                    <tr class="record">
                        ...
                        <td><a rel="facebox" href="editpartner.php?id=<?php echo $row['partner_id']; ?>">
                            ...
                            <a href="#" id="<?php echo $row['partner_id']; ?>" class="delbutton"
