...
for ($i = 0; $row = $result->fetch(); $i++) {
    ...
    <form action="saveeditpartner.php" method="post">
        <div style="text-align: center;"><h4><i class="icon-edit icon-large"></i> Edit Partner</h4></div>
        <hr>
        <div id="ac">
            <input type="hidden" name="memi" value="<?php echo $id; ?>"/>
            <span>Partner Name : </span><input type="text" style="width:265px; height:30px;" name="name"
                                               value="<?php echo $row['partner_name']; ?>"/><br>
            <span>Address : </span><input type="text" style="width:265px; height:30px;" name="address"
                                          value="<?php echo $row['partner_address']; ?>"/><br>
            ...
            <span>Contact No.: </span><input type="text" style="width:265px; height:30px;" name="contact"
                                             value="<?php echo $row['partner_contact']; ?>"/><br>
            ...
            <span>Discount: </span><input type="text" style="width:265px; height:30px;" name="discount"
                                              value="<?php echo $row['discount']; ?>"/><br>
