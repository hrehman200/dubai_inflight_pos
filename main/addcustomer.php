...
<span>User Credit-Time : </span><input type="text" style="width:265px; height:30px;" name="user_credit_time" placeholder="User Credit-Time"/><br>
<span>User Credit-Cash : </span><input type="text" style="width:265px; height:30px;" name="user_credit_cash" placeholder="User Credit-Cash"/><br>
<span>Purchased Date : </span><input type="date" style="width:265px; height:30px;" name="purchased_date" placeholder="Purchased Date"/><br>
